...
<body>
	...
	<div class="centercontent">
		<div class="pageheader">
			...
			<span class="pagedesc">未审核的稿件都在这啦！！！</span>
			<ul class="hornav">
				<li class="current"><a href="./message_listByUnRead.action">未审稿件</a></li>
					...
					<s:iterator value="#msgp.datas">
						<tr>
							...
							<s:if test="#session.admin != null">
								...
								<a href="./message_delete.action?msg_id=${msg_id }"><font color="red">删除</font></a>
							</td>
						</tr>
					</s:iterator>
