				...
				<tbody>
					...
					<s:iterator value="#msgp.datas">
						<tr>
							...
							<td>
							<s:if test="msg_status!='1'.toString()">
							...
							<td>
								...
								<s:if test="#session.admin == null && msg_status=='1'.toString()">
									<a href="./message_updateInput.action?msg_id=${msg_id }">修改</a>
								</s:if> <s:else>
									<a href="./message_view.action?msg_id=${msg_id }">查看</a>
								</s:else> <a href="./message_delete.action?msg_id=${msg_id }"><font
