...
<body>
	...
	<form action="admin_update.action" method="get">
		<input type="hidden" name="admin_id" value="${session.admin.getAdmin_id() }">
		<table>
			<tr bgcolor="#FFFFFF">
			...
			<tr bgcolor="#FFFFFF">
				...
				<td width="75%" bgcolor="#FFFFFF"><input type="password"
					id="userPw2" name="admin_password" size="22" /></td>
			</tr>
			<tr bgcolor="#FFFFFF">
				<td width="25%" bgcolor="#FFFFFF" align="right">&nbsp;</td>
				<td width="75%" bgcolor="#FFFFFF"><input type="submit"
	...
	<script language="javascript">
		function check() {
			var userPwReal = "${session.admin.admin_password}";
